...
for (const attribute of ["preferred_origin_airport", "lifetime_booking_count", "vip_status", "loyalty_tier", "watched_price_destination", "deal_affinity", "price_sensitivity", "active_itinerary_items", "abandoned_cart_items", "booking_lifecycle_stage", "traveler_composition", "preferred_product_categories", "preferred_trip_types", "destination_affinities", "top_destination", "Last name", "has_active_booking", "searches_last_7d", "Profile activity", "Abandoned Booking", "Last Viewed Item", "Last Search Details", "Last Booking Started Details", "Last Wishlist Item Added", "Last Viewed Offer Details", "Last Viewed Destination Details", "Last Search Performed Details", "Last Purchased Item Destination", "User's Email (from Purchase or Shipping)", "First name", "Last Viewed Item List Name", "Total Lifetime Purchase Value"]) {
...
for (const field of ["preferred_origin_airport", "lifetime_booking_count", "vip_status", "loyalty_tier", "watched_price_destination", "deal_affinity", "price_sensitivity", "active_itinerary_items", "abandoned_cart_items", "booking_lifecycle_stage", "traveler_composition", "preferred_product_categories", "preferred_trip_types", "destination_affinities", "top_destination", "abandoned_booking", "last_viewed_item", "last_search_details", "last_booking_started_details", "last_wishlist_item_added", "last_viewed_offer_details", "last_viewed_destination_details", "last_search_performed_details", "last_purchased_item_destination", "email", "first_name", "last_name", "has_active_booking", "searches_last_7d", "profile_activity", "last_viewed_item_list_name", "total_lifetime_purchase_value"]) {
