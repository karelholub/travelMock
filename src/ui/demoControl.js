...
export function demoControlPage(state) {
  ...
  return `
    ...
    <section class="cockpit-strip">
      ...
      <article><span>Destination</span><strong>${fields.last_purchased_item_destination || fields.next_trip_destination || activePersona.preferredDestination}</strong></article>
    ...
    <section class="control-panels">
      ...
      <article class="summary-card profile-debug-card">
        ...
        <div class="debug-grid">
          ...
          ${signalRow("email", fields.email || state.booking?.email || "pending checkout identity")}
          ${signalRow("first_name", fields.first_name || state.booking?.first_name || "pending")}
          ${signalRow("destination", fields.last_purchased_item_destination || fields.next_trip_destination || "pending")}
          ...
          ${signalRow("list_name", fields.last_viewed_item_list_name || "pending")}
          ${signalRow("lifetime_value", fields.total_lifetime_purchase_value || fields.booking_value || "pending")}
        </div>
      </article>
